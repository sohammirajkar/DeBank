            ...
            <header className="flex flex-col gap-5 md:gap-8">
                <Link href="/" className="cursor-pointer flex
                    ...
                    <h1 className="text-26 font-ibm-plex-serif 
                        font-bold text-black-1">DeBank</h1>
                </Link>
                            ...
                            {type === 'sign-up' && (
                                <>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <CustomInput control={form.control} name='postalCode' label="Postal Code" placeholder="Example: 94143" />
                                    </div>
                                    <div className="flex gap-4">
                                        <CustomInput control={form.control} name='dob' label="Date Of Birth" placeholder="mm-dd-yyyy" />
                                        <CustomInput control={form.control} name='ssn' label="SSN" placeholder="ex: xxx-xx-xxxx" />
                                    </div>
